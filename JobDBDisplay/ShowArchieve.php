...
$JobsPerPage=10;
$PagesToShowAfterCurrentPage=10;
...
<table width="500" border = "0">
	<tr>
		<td>
<div align="center" style="color:red ; font-size:15pt">
	<b>These are old Jobs for recent jobs Please <a href="http://www.peshawarjobs.com/recentjobs.php">click here</a> </b>
	
</div>
		</td>
	</tr>
</table>
<img src="1pixel.gif" width="1" height="43" />
 <br/>
<?php

$sql="select * from tblaccessjobs where ArchieveIT='1' order by AccessID desc";
$paging->query($sql);
	...
	<tr>
		<td valign="top"  height="19" bgcolor="#FFFFFF">
			<span class="AnnounceDate">
				Announce: <!--BeforeAnn <?=$SingleRow["ID"]?>--><?=$SingleRow["AnnouncedDate"]?><!--AfterAnn <?=$SingleRow["ID"]?> -->
			</span>
		</td>
