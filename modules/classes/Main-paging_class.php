...
class paging
{
    ...
    /**
     * function later added by zain to separate templates
     * @param $vHref
     * @param $vTitlel
     */
    ...
    {
        if ($vHref){
            $vReturn = "<li><a href='$vHref'>". $vTitle ."</a></li>\n";
        }
        else{
            $vReturn = "<li class='active'><a href='javascript:void(0)'>". $vTitle ."</a></li>\n";
        }
        return $vReturn;
    }
    ...
    function print_link($InternalVar = "")
    {
        ...
        if ($this->p["count"] > $this->p["baris"]) {
            ...
            $print_link.= $this->link_template('',$PrintLinkK);
