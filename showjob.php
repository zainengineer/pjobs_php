...
if (!$DescriptiveAdd) {
    ...
    ?>
    <p align="center">PeshawarJobs.com helps you find jobs in Peshawar, NWFP and all over Pakistan. PeshawarJobs.com is
        platform for JobSeekers to find jobs while sitting in their homes and offices. You don't need to check
        newspapers of Peshawar, NWFP or Pakistan to search for jobs. All you have to do is to go to
        <a href="http://www.PeshawarJobs.com">PeshawarJobs.com</a> . Choose the Job which suits you. See details of
        jobs. And apply for Jobs. Keep visiting PeshawarJobs.com for Job Opportunities. Don't miss your career
        opportunities. Wish you best of Luck. </p>
<?php
}
